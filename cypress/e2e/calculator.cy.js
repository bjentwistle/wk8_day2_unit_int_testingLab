describe("Calculator", () => {
  ...
  xit("do the number buttons update the display of the running total", () => {
    cy.get('#number3').click();
    cy.get('#number7').click();
    cy.get('.display').should('contain', '37')
  })

  xit("Do the arithmetical operations update the display with the result of the operation", () => {
  ...
  xit("Is the output as expected for positive numbers", () => {
    cy.get("#number8").click();
    cy.get('.display').should("contain", "8")
  })

  xit("Is the output as expected for negative numbers", () => {
    cy.get("#number8").click();
    cy.get('#operator-subtract').click();
  ...
  xit("Is the output as expected for decimals", () => {
    cy.get("#number8").click();
  ...
  xit("Is the output as expected for very large numbers", () => {
    cy.get("#number8").click();
